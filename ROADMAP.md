...
| - | --------- | ------ | ------ | ------ |
| 1 | Spec & schema | This repo's `SPEC.md` + `schema/*.json` + stub MCP server | ✅ committed v0.1 | 2026-W21 |
| 2 | v0.2 — SQLite implementation | Working server: all 4 tools real, BM25 recall, append-only versioning | 🔜 | 2026-W23 |
